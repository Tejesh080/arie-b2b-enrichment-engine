...
<div class="card">
  ...
  same data, not a rounding error (see <code>docs/benchmark.md</code>'s own note on this
...
<div class="card">
  ...
  human labels or reviews any lead in this benchmark's oracle. See <code>docs/benchmark.md</code>.</p>
...
<div class="wrap">
  ...
  <footer>
    ...
    <code>docs/benchmark.md</code>, <code>docs/adr/0004-evoi-is-a-negative-result.md</code>. This
